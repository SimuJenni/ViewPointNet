...
class VPNetTrainer:
    ...
    def generator_loss(self, imgs1, dec_ed1, imgs2, dec_ed2, disc_out1, disc_out2,  labels_gen):
        ...
        gen_ae_loss = tf.contrib.losses.mean_squared_error(predictions=dec_ed1, labels=imgs1, scope=gen_loss_scope, weight=50.0)
        gen_ae_loss += tf.contrib.losses.mean_squared_error(predictions=dec_ed2, labels=imgs2, scope=gen_loss_scope, weight=50.0)
