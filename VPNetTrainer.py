...
class VPNetTrainer:
    ...
    def generator_loss(self, imgs1, dec_ed1, imgs2, dec_ed2, disc_out1, disc_out2,  labels_gen):
        ...
        gen_ae_loss = slim.losses.sum_of_squares(imgs1, dec_ed1, scope=gen_loss_scope, weight=50.0)
        gen_ae_loss += slim.losses.sum_of_squares(imgs2, dec_ed2, scope=gen_loss_scope, weight=50.0)
